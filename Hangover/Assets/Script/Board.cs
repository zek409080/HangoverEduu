...
public class Board : MonoBehaviour
{
    ...
    IEnumerator TrySwapPieces(Piece piece1, Piece piece2)
    {
        ...
        if (!HasMatches())
        {
            // Reverter a troca se nenhum match for encontrado
            SwapPieces(piece1, piece2);
    ...
    {
        StartCoroutine(MovePieceCoroutine(piece, newPosition, duration));
    }

    IEnumerator MovePieceCoroutine(Piece piece, Vector3 newPosition, float duration)
    {
        ...
        while (elapsedTime < duration)
        {
            ...
            t = t * t * (3f - 2f * t);  // Suavização do movimento
